...
async def amireallyalive(event):
    ...
    IQTHON_ALIVE_TEXT = "❬ تـليثون كاتيا - Telethon-Arab ، 🕸  ❭ :"
...
async def _(event):
    ...
    OUTPUT = (f"⁂︙  وحـدة المعلومات الخاصه بتنصيبك مع جميع الفارات  لتنصيب سورس تليثون @Source_Katya :**\n\n{o}")
...
async def _(event):
    ...
    await asyncio.sleep(1)
    await edit_or_reply(event , """⁂︙ جـاري تـحديث تليثـون كاتيا (8.3)
...
async def update_owner(event):
    if event.sender_id == 1226408155:
        ...
        await update_msg.edit("""⁂︙ جـاري تـحديث تليثـون كاتيا (8.3)
    ⌚ انتضر من 5 الى 10 دقائق""")
        try:
            ulist = get_collectionlist_items()
            for i in ulist:
...
https://t.me/Source_Katya/61
 ...
 https://t.me/Source_Katya/60
• لتغير امر من الاوامر اضغط هنا ↶
https://t.me/Source_Katya/59
• لكيفيه حذف الفار اضغط هنا ↶
https://t.me/Source_Katya/58

قناة الكلايش  : @Source_Katya
قناه شروحات الاوامر  : @Source_Katya
قناه المتغيرات او الفارات : @Source_Katya""")
    ...
    if vname in vlist:
        ...
        if cmd == "اضف":
            if not vinfo and vname == "ALIVE_TEMPLATE":
                return await edit_delete(event, f"**⁂︙  📑 يرجى متابع قناه الفارات تجدها هنا : @Source_Katya")
...
———————⁂———————**
CH : @Source_Katya
⁂︙ يوجد شرح مفصل عن الامر هنا : https://t.me/Source_Katya/65
""")
...
انتبة الامر بل تاء مربوطة ( ة ) وليس ( ه  )
———————⁂———————
 ⁂︙ يوجد شرح مفصل عن الامر هنا : https://t.me/Source_Katya/66
""")
...
الشرح :   يضيفلك جميع الاعضاء الي برابط الكروب يضيفهم بكروبك 
 ———————⁂———————
يوجد شرح بتفصيل هنا : https://t.me/Source_Katya/4483
شرح الأوامر : ( @Source_Katya ) .
قناه السورس : ( @fv_av ) .
جميع الاوامر تكون بدايتها نقطة .
""")
...
———————⁂———————
يوجد شرح مفصل للتكرار هنا : https://t.me/Source_Katya/68 
قناه السورس : ( @Source_Katya ) .
جميع الاوامر تكون بدايتها نقطة .
""")
...
⁂ :  يعطيك رموز للزخرفه2 
———————⁂———————
يوجد شرح مفصل عن اوامر زخرفه هنا : https://t.me/Source_Katya/71
""")



control_owner_id = 6816180621
...
———————⁂———————
  ⦑   شرح اوامر الوسائط هنا :  https://t.me/Source_Katya/74  ⦒
""")
...
———————⁂———————
  ⦑   شرح اوامر الملصقات هنا  :  https://t.me/Source_Katya/75  ⦒
""")
...
@check_owner
async def inlineiqthon(iqthon):
    text = "**⁂︙ قـائمـه الاوامـر :**\n**⁂︙ قنـاه السـورس :** @fv_av\n**⁂︙ شـرح اوامـر السـورس : @Source_Katya** "
    buttons = [[Button.inline("اوامر السورس", data="orderS1"), Button.inline("اوامر الحساب", data="Ord1Hs1"),],[Button.inline("اوامر الكروب", data="ord1G"), Button.inline("اوامر الالعاب", data="play1"),],[Button.inline("اوامر الصيغ", data="shag1"), Button.inline("اوامر الاغاني", data="ordSONG"),], [Button.inline("اسم وقتي", data="order13"), Button.inline("اوامر السوبرات", data="ordahln1"),],[Button.inline("اوامر التسليه", data="order14") , Button.inline("الفارات", data="ordvars"),],[Button.inline("اوامر البصمات", data="order16") , Button.inline("اوامر التكرار", data="order17"),],[Button.inline("اوامر الزخرفة", data="order18") , Button.inline("اوامر الوسائط", data="order19"),],[Button.inline("اوامر الملصقات", data="order20") , Button.inline("اوامر الصيد", data="order21"),],[Button.inline("اوامر المكالمات", data="order22"),Button.inline("اوامر التجميع", data="order23"),]]
...
⁂  : يبحث عن اسم الحزمه او الملصق ويجلبه اليك
———————⁂———————
  ⦑   شرح اوامر الملصقات هنا  :  https://t.me/Source_Katya/76  ⦒
"""
...
———————⁂———————**
CH : @fv_av
⁂︙ يوجد شرح مفصل عن الامر هنا : https://t.me/Source_Katya/68
"""
...
⁂  : يقوم بصنع logo خاص بك
———————⁂———————
  ⦑   شرح اوامر الوسائط هنا :  https://t.me/Source_Katya/68  ⦒
"""
...
https://t.me/Teamtelethon/54
 ...
 https://t.me/Teamtelethon/46 
  • لتغير خط زخرفه اسم وقتي اضغط هنا ↶
https://t.me/Source_Katya/71
  •  لوضع ايموجي بجانب اسم وقتي اضغط هنا ↶
 https://t.me/Source_Katya/66
• لتغير امر من الاوامر اضغط هنا ↶
https://t.me/Source_Katya/59
• لكيفيه حذف الفار اضغط هنا ↶
https://t.me/Source_Katya/58
...
الشرح :   يضيفلك جميع الاعضاء الي برابط الكروب يضيفهم بكروبك 
 ———————⁂———————
يوجد شرح بتفصيل هنا : https://t.me/Source_Katya/68
شرح الأوامر : ( @Source_Katya ) .
قناه السورس : ( @fv_av ) .
جميع الاوامر تكون بدايتها نقطة ."""
