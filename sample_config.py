...
class Config(object):
    LOGGER = True
    ALIVE_NAME = os.environ.get("ALIVE_NAME", "@Source_Katya")
    ...
    UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/Mazensaid24/Katya_pro")
    AUTONAME = os.environ.get("AUTONAME", "@Source_Katya")
    ...
    THUMB_IMAGE = os.environ.get("THUMB_IMAGE", "https://graph.org/file/b66ef25850f144ce1ce46.jpg")
